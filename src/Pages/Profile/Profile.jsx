...
function Profile() {
    ...
    async function fetchCartLength() {
        try {
            ...
            const data = await response.json();
            setCartTotalPrice(data.subtotal_price)
...
function handleNewAddress() {
            ...
            <div className="max-w-md w-full bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div className="px-6 py-4">
                    <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <ProfileItem title="Total" content={`₹${cartTotalPrice} /- `} />
                    </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 z-50">
        <div className="p-3 bg-white w-4xl">
            <div className="flex items-center justify-between">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-2 gap-3">
                ...
                <input
                    ...
                    onBlur={async () => {
                        try {
                            const response = await fetch(`https://api.postalpincode.in/pincode/${newAddress.postal_code}`);
                            const data = await response.json();
            ...
            <button
                ...
                className="mt-4 btn bg-red-500 hover:bg-red-600 text-white w-full">Submit
            </button>
        </div>
    </div>
)}
